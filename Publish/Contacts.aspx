...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">       
    ...
    <tr><td align="left" class="textsite">
        <span style="font-size: 14pt; color: darkgreen;">3.</span></td><td align="center" valign="middle"><img alt="ул. Еременко 62 ТЦ 'ВОСХОД'" src="Images/mapEremenko2.jpg" width="300px" height="300px" border="0" /></td><td class="textsite" align="center" valign="middle">
        <span style="font-size: 14pt; color: darkgreen;">ул. Еременко 62 ТЦ&nbsp;"ВОСХОД"</span></td><td class="textsite" style="font-size: 12pt">
        <span style="font-size: 14pt; color: darkgreen;">тел. 296-99-61</span></td></tr>
