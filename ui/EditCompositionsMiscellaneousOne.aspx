<%@ Page Title="Соцветие сеть цветочных салонов. Ростов-на-Дону. Редактирование разной композиции." Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditCompositionsMiscellaneousOne.aspx.cs" Inherits="EditCompositionsMiscellaneousOne" %>
...
<tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SocvetieSqlServer %>" SelectCommand="SELECT * FROM [CompositionsMiscellaneous]"></asp:SqlDataSource>
