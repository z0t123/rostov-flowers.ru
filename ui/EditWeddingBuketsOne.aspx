<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditWeddingBuketsOne.aspx.cs" Inherits="EditWeddingBuketsOne" Title="Соцветие сеть цветочных салонов. Ростов-на-Дону. Редактирование одного букета невесты." %>
...
<tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SocvetieSqlServer %>" SelectCommand="SELECT * FROM [WeddingBukets]"></asp:SqlDataSource>
