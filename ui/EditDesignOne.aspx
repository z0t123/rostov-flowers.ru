<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditDesignOne.aspx.cs" Inherits="EditDesignOne" Title="Соцветие сеть цветочных салонов. Ростов-на-Дону. Редактирование одного дизайна." %>
       ...
       <table border="0" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td valign="middle" align="left">
                ...
                <br />
                <asp:Label ID="Label6" runat="server" Text="желательно, чтобы высота и ширина были 700x700" Font-Bold="True" ForeColor="Red"></asp:Label>
                <br />
...
<tr>
    <td>
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Описание:"></asp:Label>    
    </td>
    <td>
        <asp:TextBox ID="TextBoxText" runat="server" Rows="9" TextMode="MultiLine" Width="400px"></asp:TextBox>
    </td>
</tr>
<tr>
    <td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SocvetieSqlServer %>"></asp:SqlDataSource>
