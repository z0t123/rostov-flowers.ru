<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditWeddingBukets.aspx.cs" Inherits="EditWeddingBukets" Title="Соцветие сеть цветочных салонов. Ростов-на-Дону. Редактирование букета невесты." %>
        ...
        <ItemTemplate>
                ...
                <td><asp:Label ID="Label1" runat="server" CssClass="textsite" Text="№ п/п: "></asp:Label></td>
                    ...
                    <td style="padding-left:50px;" valign="middle">
                        <asp:HyperLink  ID="HyperLinkEditDesignOne" NavigateUrl='<%# "~/EditWeddingBuketsOne.aspx?ItemID=" +  Eval("ItemID") + "&PageIndex=" + GridView1.PageIndex %>' runat="server"><img border="0" src="Images/edit_icon.gif" alt="Изменить" /></asp:HyperLink >
                    </td>
...
<tr><td style="padding-top:15px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SocvetieSqlServer %>"
        SelectCommand="SELECT * FROM [WeddingBukets] ORDER BY [number]"></asp:SqlDataSource>
...
function ConfirmDelete(id,pageindex)
{
    ...
    {
        window.open("EditWeddingBukets.aspx?DeleteItemID=" + id + "&PageIndex=" + pageindex,"_self");
    } 
}
</script>
</asp:Content>